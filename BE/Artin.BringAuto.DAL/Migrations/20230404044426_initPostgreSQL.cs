        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stops_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionLogged = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ...
                    Button = table.Column<int>(type: "integer", nullable: false),
                    UnderTest = table.Column<bool>(type: "boolean", nullable: false),
                    CarAdminPhone = table.Column<string>(type: "text", nullable: true),
                    CallTwiml = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Arrive = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    CarId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    FromStationStatus = table.Column<int>(type: "integer", nullable: false),
                    ToStationStatus = table.Column<int>(type: "integer", nullable: false),
                    FromStationPhone = table.Column<string>(type: "text", nullable: true),
                    ToStationPhone = table.Column<string>(type: "text", nullable: true),
                    TenantId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
